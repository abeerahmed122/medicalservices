...
<!--     Bootstrap CSS-->
  ...
  <body>
    ...
    <div class="cont-main" style="background-image: url('assets/images/bg-1.jpg')">
        <div class="container">
            <div class="row">
          <div class="col-sm-12">
              <?php //
                if (isset($_POST['submit']))
                {
                    ...
                    {
                        $sql  = "INSERT INTO orders (`ord_name`,`ord_email`,`ord_mobile`,`ord_serv_id`,`ord_city_id`,`ord_notes`)
